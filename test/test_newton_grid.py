...
def test_newton_grid_rootfinder() -> None:
    ...
    """
    testSuite : List[List[Callable[[float], float], Callable[[float], float], List[float]]] = [
        ...
        [np.exp, np.exp, []],
        [lambda x: x**5-4*x+2, lambda x: 5*x**4-4, [0.508499484, -1.51851215, 1.2435963, -0.116791-1.43844769j,-0.116791+1.43844769j]]
    ]
    for t in testSuite:
...
def rootsMatchClosely(r1 : Set[complex], r2 : Set[complex], atol: float=10**-6) -> bool:
    r"""
