...
settings. If you want to know more about customizing the root finding process the :ref:`User API Guide <user_guide>`
is a good place to start. If you are interested in learning more about the mathematical background of the different
root finding modes visit :ref:`Theoretical Background <theory>`. There you can also find a list of original
references.
